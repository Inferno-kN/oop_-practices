...
class TouristSpot:
    ...
    def info(self):
        print(f"Место: {self.place}, Страна: {self.country}, Достопримечательность: {self.sight}")
...
class ModelWindow:
    ...
    def change_height(self, new_height: int) -> bool:
        if 0 <= new_height <= ModelWindow.height_screen:
            ...
            print(
                f"Недопустимая высота: {new_height}. Высота должна быть в пределах от 0 до {ModelWindow.height_screen}.")
            return False
    ...
    def change_width(self, new_width: int) -> bool:
        if 0 <= new_width <= ModelWindow.width_screen:
            ...
            print(
                f"Недопустимая ширина: {new_width}. Ширина должна быть в пределах от 0 до {ModelWindow.width_screen}.")
            return False
